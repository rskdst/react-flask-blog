...
def get_users():
    user_list = db.session.query(User.id,User.username,User.phone,User.id_card,User.mail,User.state,User.create_date,User.update_date,User.role_id,Role.rolename).all()
